...
from Doraemon import Telegram, YouTube, app
from Doraemon.misc import SUDOERS
from Doraemon.plugins.robot.playlist import del_plist_msg
from Doraemon.plugins.robot.sudoers import sudoers_list
from Doraemon.utils.database import (add_served_chat,
                                       add_served_user,
                                       blacklisted_chats,
                                       get_assistant, get_lang,
                                       get_userss, is_on_off,
                                       is_served_private_chat)
from Doraemon.utils.decorators.language import LanguageStart
from Doraemon.utils.Inline import (help_pannel, private_panel,
                                     start_pannel)
...
⏳ **ᗪᑌᖇᗩTIOᑎ:** {duration} ᴍɪɴᴜᴛᴇs
👀 **ᐯIᗴᗯՏ:** `{views}`
⏰ **ᑭᑌᗷᒪIՏᕼᗴᗪ Oᑎ:** {published}
🎥 **ᑕᕼᗩᑎᑎᗴᒪ:** {channel}
📎 **ᑕᕼᗩᑎᑎᗴᒪ ᒪIᑎK:** [ᐯIՏIT ᑕᕼᗩᑎᑎᗴᒪ]({channellink})
🔗 **ᒪIᑎK:** [ᗯᗩTᑕᕼ Oᑎ YOᑌTᑌᗷᗴ]({link})

💖 Տᗴᗩᖇᑕᕼ ᑭOᗯᗴᖇᗴᗪ ᗷY {config.MUSIC_BOT_NAME}"""
            key = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="• YOᑌTᑌᗷᗴ •", url=f"{link}"
                        ),
                        InlineKeyboardButton(
